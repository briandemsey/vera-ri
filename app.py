...
def check_password():
    ...
    <div style="text-align: center; padding: 60px 20px;">
        <h1 style="color: {RI_BLUE}; font-size: 3rem; margin-bottom: 10px;">VERA-RI</h1>
        <p style="color: #666; font-size: 1.1rem; margin-bottom: 40px;">
            Verification Engine for Results &amp; Accountability<br>Rhode Island Implementation
        </p>
    </div>
    ...
    with col2:
        ...
        if st.button("Access VERA-RI", use_container_width=True):
    ...
    <div style="text-align: center; margin-top: 60px; color: #999; font-size: 0.85rem;">
        <p>VERA-RI analyzes ACCESS for ELLs domain data and RICAS results across 66 Rhode Island LEAs.</p>
        <p>~15,000 MLLs (11% of enrollment) | MLL population doubled | Providence 33% MLL</p>
        <p>Providence state takeover (2019-2024) | Central Falls 45% MLL</p>
